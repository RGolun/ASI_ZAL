...
class BallsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ball" do
    assert_difference('Ball.count') do
      post balls_url, params: { ball: { brand: @ball.brand, description: @ball.description, size: @ball.size } }
    end
  ...
  test "should update ball" do
    patch ball_url(@ball), params: { ball: { brand: @ball.brand, description: @ball.description, size: @ball.size } }
